...
namespace Widgets.MembersOnly
{
    public class MembersOnlyWidgetProvider : IWidgetProvider
    {
        ...
        public async Task<IList<string>> GetWidgetZones()
        {
            ...
            //{
            //    MembersOnlyWidgetDefaults.WidgetZoneHomePage,
            //    MembersOnlyWidgetDefaults.WidgetZoneCategoryPage,
            //    MembersOnlyWidgetDefaults.WidgetZoneCollectionPage,
            //    MembersOnlyWidgetDefaults.WidgetZoneBrandPage,
            //});
